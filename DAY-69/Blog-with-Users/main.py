...
class BlogPost(db.Model):
    ...
    # creating a foreign key as author id
...
def register():
    ...
    if request.method == 'POST':
        ...
        # If email exists in the db then ask the user to login
        if result:
            flash("You've already signed up with this email, Login instead")
            return redirect(url_for('login'))
        # else hash and salt the password and save the details into the db
